...
public class AudioBook extends AudioContent
{
  ...
  // Play the audiobook by setting the audioFile to the current chapter title (from chapterTitles array list) 
	...
	{
		for (String chapter_title : chapterTitles) {
			System.out.println("Chapter " + (chapterTitles.indexOf(chapter_title)+1) + ". " + chapter_title + "\n");
		}
	}
	...
	public boolean equals(Object other)
	{
		...
		return super.equals(audiobook) && this.author.equals(audiobook.author) && this.narrator.equals(audiobook.narrator);
	}
